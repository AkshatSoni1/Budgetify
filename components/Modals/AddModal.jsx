                    ...
                    <div className={`relative bg-white rounded-lg shadow`}>
                        ...
                        <div className={`flex items-center justify-between p-4 md:p-5 border-b rounded-t `}>
                            ...
                            <button onClick={() => {
                                setAddToggle((addToggle) => !addToggle)
                                setBName('')
                                }} type="button" className="end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="authentication-modal">
                        ...
                        <div className="p-4 md:p-5">
                            <form className="space-y-4" onSubmit={handleSubmit}>
                                <div>
                                    <label htmlFor="name" className='block mb-2 text-md text-gray-900 font-light'>Specify the name of the budget</label>
                                    <input 
                                    value={bName}
